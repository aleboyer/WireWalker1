...
%% process rbr
%process_rbr(WWmeta)
load('/Volumes/DataDrive/SODA/WW/d3/ctd/SODA_rbr_d3.mat')
...
load('/Volumes/DataDrive/SODA/WW/d3/sd_raw/Meta_SODA_d3.mat')
starttime = datenum('2018-09-14 16:22:10');
endtime   = datenum('2018-09-16 07:27:21'); 
Meta_Data.starttime=starttime;

addpath('/Volumes/DataDrive/SODA/analyse_script/') %buildepsiWWtime.m and create_profiles_EPSIWW.m
addpath('/Users/aleboyer/ARNAUD/SCRIPPS/EPSILOMETER/EPSILON/toolbox/misc/') %get_cast_epsiWW
